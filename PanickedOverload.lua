...
SMODS.Joker {
	...
	loc_txt = {
		...
		text = {"Because what else is more fun than 5 cards?","Correct! a whole whoppin {S:1.2. X:attention,C:white}SIX{} of em!","Allows you to {C:chips}select{}","{C:white,X:mult}6{} cards instead of {C:white,X:mult}5{} on your last hand."},
	},
		discovered = true,
		unlocked = true,
		...
		calculate = function(self, card, context)
			...
			if context.joker_main then
				sendTraceMessage(G.play.config.card_limit, "PanickedOverload")
